...
from .http import JsonTransport, TransportError, TransportResponseError, TransportTimeoutError
...
class RetryingJsonTransport:
    ...
    def get_json(self, url: str, *, headers: Mapping[str, str] | None = None, timeout: float = 10.0) -> Mapping[str, Any]:
